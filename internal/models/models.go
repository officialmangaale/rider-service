...
// ActiveOrder is the rider-app response shape for the current delivery.
type ActiveOrder struct {
	...
	DropLatitude      *float64   `json:"drop_latitude,omitempty"`
	DropLongitude     *float64   `json:"drop_longitude,omitempty"`
	...
	BasePayout        float64    `json:"base_payout,omitempty"`
